...
int main(object me, string arg)
{
	...
	foreach (skill in keys(ss))
	{
		...
		msg += SPECIAL_D(skill)->name()+"("+skill+")"+" ["+me->query("tianfu/"+skill+"")+"重]"+":special "+skill+ZJSEP;
		msg += "进阶："+SPECIAL_D(skill)->name()+"("+skill+")"+":tianfu "+skill+ZJSEP;
