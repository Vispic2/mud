...
LONG  );
	...
	set("action_list",([
		HIR"武学真解"NOR:"zhenjie taixuan-gong",		
	]));	
	set("taixuan-gong_zj",1);
	set("outdoors", "xiakedao");
	set("item_desc",([
		"【瀑布】"   : "你仔细一看，瀑布里面好象有出口，你似乎可以跳(jump)进去。\n"
		ZJOBACTS2"跳进去:jump pubu\n",
		"【悬崖】" : "下面弥漫着烟雾，什么也看不见，没一定的轻身功夫掉(plump)下去绝对死翘翘！\n"
		ZJOBACTS2"跳下去:plump xuanya\n",
	]));
...
int do_jump(string arg)
{
	...
	if (n >= 50)
	{
		...
		message_vision("只见$N高高跃起，不过随即落下，看来轻身功夫还差很远呢！\n", me);
...
int do_plump(string arg)
{
	...
	tell_object(ob,HIR "你不加思索，纵身跳下了悬崖。"NOR"\n");
