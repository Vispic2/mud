...
int do_decide()
{
	...
	message_vision(HIC "海大富叹了口气，道：既然这样……小桂子，过来帮我给这"
		       ...
		       "\n$N" HIC "一咬牙，躺上案板，褪下了中衣。"NOR"\n" + HIR
		       "$n" HIR "摇了摇头，伸出长剑插到$N" HIR "两腿之间，飞速一"
		       "剜………\n\n$N" HIR "顿时惨叫一声昏了过去……"NOR"\n",
