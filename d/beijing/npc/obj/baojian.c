...
void create()
{
	...
	if (clonep())
		...
		set("value", 100000);
		set("material", "gold");
		set("wield_msg", HIR"$N抽出一柄寒气逼人的"NOR+WHT"玄铁"NOR+HIW"匕首"NOR+HIR"拿在手中，只感到一阵"NOR+HIW"寒气"NOR+HIR"扑面而来。"NOR"\n");
		set("unwield_msg", HIR"$N将手中的"NOR+WHT"玄铁"NOR+HIW"匕首"NOR+HIR"插回靴中。"NOR"\n");
	}
	init_sword(200);
	setup();
}
