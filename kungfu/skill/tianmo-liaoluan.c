...
mapping *action = ({
([      "action": "$N虚步提腰，一招「天魔缭乱」，手中$w轻轻颤动，一剑剑点向$n的$l",
	"force" : 25,
	"dodge" : 20,
	"parry" : 25,
	"lvl"   : 0,
...
([      "action": "$N向前跨上一步，左手剑诀，右手$w使出一式「天魔缭乱」直刺$n的$l",
	"force" : 30,
	"dodge" : 25,
	"parry" : 30,
	"lvl"   : 6,
...
([      "action": "$N身形往右一挫，左手剑诀，右手$w使出一式「天魔缭乱」刺向$n的$l",
	"force" : 30,
	"dodge" : 35,
	"parry" : 35,
	"lvl"   : 12,
...
([      "action": "$N双膝下沉，右手$w使出一式「天魔缭乱」，由下而上疾刺$n的$l",
	"force" : 35,
	"dodge" : 35,
	"parry" : 40,
	"lvl"   : 15,
...
([      "action": "$N一招「天魔缭乱」，$w自上而下划出一个大弧，平平地向$n的$l挥去",
	"force" : 35,
	"dodge" : 45,
	"parry" : 45,
	"lvl"   : 18,
...
([      "action": "$N上身往左侧一拧，一招「天魔缭乱」，右手$w反手向$n的$l挥去",
	"force" : 35,
	"dodge" : 45,
	"parry" : 55,
	"lvl"   : 21,
...
([      "action": "$N一招「天魔缭乱」，一招「天魔缭乱」，剑锋平指，一气呵成横扫$n的$l",
	"force" : 40,
	"dodge" : 60,
	"parry" : 55,
	"lvl"   : 24,
...
([      "action": "$N左腿提膝，手中$w斜指，一招「天魔缭乱」刺向$n的$l",
	"force" : 40,
	"dodge" : 55,
	"parry" : 60,
	"lvl"   : 27,
...
([      "action": "$N一招「天魔缭乱」，$w自下而上划出一个大弧，平平地挥向$n的$l",
	"force" : 45,
	"dodge" : 65,
	"parry" : 65,
	"lvl"   : 30,
...
([      "action": "$N使出「天魔缭乱」，$w划出三个圆圈，剑锋直出，绵绵不断划向$n的$l",
	"force" : 45,
	"dodge" : 70,
	"parry" : 70,
	"lvl"   : 35,
...
([      "action": "$N一招「天魔缭乱」，$w轻灵地划出几个圆弧，迅速地向$n的$l挥去",
	"force" : 50,
	"dodge" : 75,
	"parry" : 80,
	"lvl"   : 40,
...
([      "action": "$N一招「天魔缭乱」，$w划出一个左低右高的大弧，斜斜地斩向$n的$l",
	"force" : 50,
	"dodge" : 75,
	"parry" : 80,
	"lvl"   : 45,
...
([      "action": "$N使出「天魔缭乱」，$w由右向左划出一个大８字，将$n圈在其中",
	"force" : 55,
	"dodge" : 85,
	"parry" : 80,
	"lvl"   : 50,
...
([      "action": "$N左脚踏实，右脚虚点，一招「天魔缭乱」，右手$w带着一团剑花，逼向$n的$l",
	"force" : 55,
	"dodge" : 95,
	"parry" : 80,
	"lvl"   : 60,
...
([      "action": "$N轻轻跃起，一招「天魔缭乱」，$w在半空中化为一圈银芒，落向$n的$l",
	"force" : 60,
	"attack": 3,
	"dodge" : 95,
	"parry" : 90,
...
([      "action": "$N两腿前箭后弓，一招「天魔缭乱」，右手$w直刺$n的$l",
	"force" : 65,
	"attack": 5,
	"dodge" : 100,
	"parry" : 100,
...
([      "action": "$N一招「天魔缭乱」，身形往左一挫，左手剑诀，右手$w平平地向$n的$l挥去",
	"force" : 70,
	"attack": 7,
	"dodge" : 100,
	"parry" : 105,
...
([      "action": "$N猱身扑上，一招「天魔缭乱」，手中$w斜斜地向$n的$l挥去",
	"force" : 75,
	"attack": 10,
	"dodge" : 110,
	"parry" : 120,
...
([      "action": "$N一招「天魔缭乱」，$w看似随意地一挥，$n却陡觉一股劲气迎面袭来。",
	"force" : 80,
	"attack": 12,
	"dodge" : 105,
	"parry" : 115,
...
([      "action": "$N突然盘蹲下身来，一招「天魔缭乱」，$w自下而上地向$n的$l挥去",
	"force" : 95,
	"attack": 20,
	"dodge" : 125,
	"parry" : 125,
...
([      "action": "$N一招「天魔缭乱」，$w自下而上徐徐划出一个大弧，平平地向$n的$l挥去",
	"force" : 100,
	"attack": 22,
	"dodge" : 135,
	"parry" : 145,
...
([      "action": "$N一招「天魔缭乱」，身形跃起，右手$w刺向$n的$l",
	"force" : 110,
	"attack": 28,
	"dodge" : 145,
	"parry" : 155,
...
([      "action": "$N一招「天魔缭乱」，$w化作一片银盘，平平地向$n的$l卷去",
	"force" : 115,
	"attack": 28,
	"dodge" : 155,
	"parry" : 175,
...
([      "action": "$N左脚轻点地面，身形往前一扑，一招天魔缭乱」，$w向$n的$l挥去",
	"force" : 120,
	"attack": 29,
	"dodge" : 165,
	"parry" : 180,
...
([      "action": "$N一招「天魔缭乱」，身体跃在半空，手中$w扫向$n的$l",
	"force" : 125,
	"attack": 32,
	"dodge" : 175,
	"parry" : 185,
...
([      "action": "$N一招「天魔缭乱」，左脚跃步落地，$w回抽，反手勾向$n的$l",
	"force" : 130,
	"attack": 35,
	"dodge" : 185,
	"parry" : 200,
...
([      "action": "$N右腿半屈般蹲，一招「天魔缭乱」，剑尖虚指，转身撩向$n的$l",
	"force" : 135,
	"attack": 38,
	"dodge" : 185,
	"parry" : 220,
...
([  "action" : "$N回身拧腰，右手虚抱，一招「天魔缭乱」，$w中宫直进，刺向$n的$l",
	"force" : 150,
	"attack": 40,
	"dodge" : 220,
	"parry" : 220,
...
"但见$N剑法吞吐开合、阴阳动静，实已到了天魔缭乱法的绝诣",
"$N手中$w虽使得极快，却丝毫听不到金刃劈风之声，足见剑劲之柔韧已达于化境",
"$N将剑法中最精要之处都发挥了出来，愈战愈强，$w发出的内劲不断增强",
"天魔缭乱法乃巫师晚年继天魔所创，实是近世登峰造极的剑术，$N功劲一加运开，绵绵不绝，绝无破绽",
...
"$N$w随手一招打出，以己之钝，挡敌之无锋，正是巫师传授的天魔缭乱「剑意」的精奥神髓",
...
"$N$w递出，顺着$n来路削下，以己之钝，挡敌之无锋，实已得了天魔缭乱法的精奥",
...
"$N剑法吞吐开合、阴阳动静，将天魔缭乱法中最精要之处都发挥了出来，功劲一加运开，绵绵不绝",
...
/*
	...
	//if ( me->query_skill("tianmo-liaoluan", 1) > me->query_skill("taiji-quan", 1)+30 )
		//return notify_fail("学习天魔缭乱需以太极拳为基础。\n");
	//f ( me->query_skill("tianmo-liaoluan", 1) > me->query_skill("taiji-shengong", 1)+30 )
		return notify_fail("学习天魔缭乱需以太极神功为基础。\n");
*/
	if ((int)me->query_skill("sword", 1) < 100)
		return notify_fail("你的基本剑法火候太浅。\n");

	if ((int)me->query_skill("sword", 1) < (int)me->query_skill("tianmo-liaoluan", 1))
		return notify_fail("你的基本剑法水平有限，无法领会更高深的天魔缭乱。\n");
...
mapping query_action(object me, object weapon)
{
	int i, level;
	string str;
	level = (int) me->query_skill("tianmo-liaoluan", 1);
...
mixed valid_damage(object ob, object me, int damage, object weapon)
{
	...
	if ((int) me->query_skill("tianmo-liaoluan", 1) < 100 ||
	...
	dp = me->query_skill("parry", 1) / 2 +
	     me->query_skill("tianmo-liaoluan", 1);
...
int practice_skill(object me)
{
	...
	if ((int)me->query("qi") < 100)
		return notify_fail("你的体力不够练天魔缭乱法。\n");

	if ((int)me->query("neili") < 120)
		return notify_fail("你的内力不够练天魔缭乱法。\n");
...
{
	return __DIR__"tianmo-liaoluan/" + action;
}
