...
int query_neili_improve(object me)
{
	...
	lvl = (int)me->query_skill("xuekui", 1);
...
mapping query_action(object me, object weapon)
{
        ...
        level   = (int) me->query_skill("xuekui",1);
...
mixed valid_damage(object ob, object me, int damage, object weapon) 
{
	...
	if ((int)me->query_skill("xuekui", 1) < 100 || 
	    ! me->query("special_skill/ghost") ||
	    ! me->query_temp("dodge_valid_damage") ||
	    me->query_skill_mapped("force") != "xuekui" ||
	    me->query_skill_mapped("parry") != "xuekui" ||
	    me->query_skill_mapped("dodge") != "xuekui" ||
	    me->query_skill_mapped("sword") != "xuekui" ||
	    ! living(me)) 
		return; 

	mp = ob->query_skill("count");
	ap = ob->query_skill("dodge") + mp; 
	dp = me->query_skill("dodge") / 2 + me->query_skill("xuekui", 1); 
...
int valid_learn(object me)
{
        ...
        if ((int)me->query_skill("xuekui", 1) < 180)
...
int difficult_level()
{
     ...
     int lv;
     me = this_player(); 
     lv = me->query_skill("xuekui", 1) - 180; 
     if (lv > 200) lv = 200; 
...
mixed hit_ob(object me, object target)
{
 ...
 //   if ( lvl = i ) me->set_temp("auto_hit",1);
    if ( me->query_skill("xuekui", 1) >= 200
         && me->query_skill_mapped("sword") == "xuekui"
