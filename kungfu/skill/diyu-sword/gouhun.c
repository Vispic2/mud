...
string query_name() { return "勾魂"ZJBR"追命"; }
...
int perform(object me, object target)
{
	...
	if ((int)me->query_skill("diyu-sword", 1) < 100)
		return notify_fail("你" + to_chinese("diyu-sword") + "不够娴熟，难以施展" PFM "。\n");
