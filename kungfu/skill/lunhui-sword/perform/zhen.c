...
string query_name() { return "真"ZJBR"六道轮回"; }
...
string attack2(object me, object target, int damage)
{
        ...
        {
                // 此特效对天晶无效
                if( weapon->query("material") == "tian jing")return msg;
...
string attack4(object me, object target, int damage)
{
        ...
        {
                // 此特效对天晶无效
                if( cloth->query("material") == "tian jing")return msg;
        ...
        {
                // 此特效对天晶无效
                if( armor->query("material") == "tian jing")return msg;
...
string attack5(object me, object target, int damage)
{
        ...
        {
                // 此招对朱蛤奇缘玩家无效
                if( target->query("death_skill/zhuha"))return msg;
...
string attack6(object me, object target, int damage)
{
        ...
        {
                // 此招对六阴鬼脉玩家无效
                if( target->query("death_skill/guimai"))return msg;
