...
int get_finish(object me)
{
	...
	{
		tell_object(me, "你演练完毕，只感葵花剑法和葵花神功毫无牵连，看来必须要激发葵花神功，否则无法将其合一。\n");
		return 0;
	}/*
	...
	{
		tell_object(me, "你演练完毕，只感葵花神功和葵花剑法毫无牵连，看"
		            "来依你的悟性，无法将其合一。\n");
	return 0;
        }
	...
	if ((int)me->query_skill("kuihua-jianfa", 1) < 500)
		return notify_fail("你的「葵花剑法」火候太浅，没法演练高深的暗夜鬼魅典。\n");
	...
	{
		tell_object(me, "你觉得自己内力修为不继，无法将葵花剑法和葵花神功二者合一。\n");
		return 0;
	}
	...
	tell_object(me, HIY "\n一阵凡尘往事涌上心头，你几欲放声长叹。霎"
	            ...
	            "典的诀窍。\n" NOR);
	message("channel:chat", HBYEL HIR"【天降奇才】"HBRED HIC + "听说"+me->query("name")+"天纵奇才，将葵花剑法与葵花神功合二为一，领悟了暗夜鬼魅典！\n"NOR,users() );
