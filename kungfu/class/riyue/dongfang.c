...
void create()
{
	...
	set("inquiry", ([
		...
		"#31-葵花宝典2"  : (: ask_baodian() :),
         ...
         "莲花老祖" : "他当年和葵花老祖一样也是宫中太监。\n",
         "葵花阴柔剑法" : "想知道吗？去把任我行的人头给我带回来。\n",
	]) );
	set("no_teach", ([
		"kuihua-shengong"     : "嘿嘿！想学葵花神功？这种技能只可以研究和读书，我可不会教你。",
        "kuihua-dafa"     : "嘿嘿！想学葵花阴柔剑？我可不会教你。",
	]));
...
int accept_object(object who, object ob)
{
        ...
        if ((! ob->is_head() && ! ob->is_corpse()) ||
          ...
          ob->query("owner_id") != "ren woxing" )
        {
                command("say 你敢糊弄我？");
                return 0;
        }

        command("say 啊……任我行的人头！ 任我行的人头！");
        command("chat 哈哈哈！……任我行的人头！ 任我行的人头！");
