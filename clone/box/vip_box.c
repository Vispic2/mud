...
void create()
{
	...
	if( clonep() )
       ...
       {
	    set("long","这是系统奖励的"+this_object()->query("name")+","ZJURL("cmds:openbox vipbox")ZJSIZE(15)"打开"NOR"看看，里面宝贝不少哦!\n");
	    set("unit","个");
	    set("win_box",1);
	}
}
...
/*		"/clone/gift/fjade","/clone/gift/fushougao","/clone/gift/fdiamond","/clone/gift/fcrystal",
