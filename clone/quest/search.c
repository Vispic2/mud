...
string query_introduce(object knower)
{
	...
	return CYN "听说" HIY + NPC1_NAME + NOR CYN "在"+PLACE1+"，丢了" +
	       HIY + QOB_NAME + NOR CYN "，有人说不知怎么的就落到了"
	       HIY + NPC2_NAME + NOR CYN "手中了(目前他在"+PLACE2+")。" NOR;
}
...
int npc_accept_object(object me, object who, object ob)
{
 ...
 //			     who->query("id") + ")替" +
  ...
  //			    HIM "，平息了一场武林风波。" NOR);
	...
	QUEST_D->bonus(who, ([ "exp" : 100 + random(100),
			       "pot" : 50 + random(50),
			       "score" : 30 + random(20),
			       "percent" : percent ]));
