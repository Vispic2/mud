...
void event_noon()
{
	...
	case 3: case 4: case 5:
		ill = "ill_kesou";
		msg = HIG + "忽然喉头一阵痕痒，你感觉似乎要咳嗽了。"NOR"\n";
		ic  = 5;
		break;
	case 6: case 7: case 8:
		ill = "ill_zhongshu";
		msg = HIG+"突然你胸臆之间一阵翻腾，你中暑了。"NOR"\n";
		ic  = 5;
		break;
	case 9: case 10: case 11:
		ill = "ill_shanghan";
		msg = HIG+"陡的你打了个冷战，头昏沉沉的，你得伤寒病了。"NOR"\n";
		ic  = 5;
		break;
	case 12: case 1: case 2:
		ill = "ill_dongshang";
		msg = HIG+"你肢体末端一阵僵直，看来你被冻伤了。"NOR"\n";
		ic  = 0;
		break;
	}
	...
	{
		ill = "ill_fashao";
		msg = HIG+"你偶感风寒，竟而发起烧来。"NOR"\n";	
		"/inherit/weapon/sms.c"->send();
	}
